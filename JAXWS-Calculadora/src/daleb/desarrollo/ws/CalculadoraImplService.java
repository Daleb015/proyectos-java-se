 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.desarrollo.daleb/", wsdlLocation = "http://localhost:1515/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.desarrollo.daleb/", "CalculadoraImplService");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.desarrollo.daleb/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.desarrollo.daleb/", "CalculadoraImplPort"), Calculadora.class, features);
    }
