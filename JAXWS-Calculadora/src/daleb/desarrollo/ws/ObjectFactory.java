 ...
 * generated in the daleb.desarrollo.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.desarrollo.daleb/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.desarrollo.daleb/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: daleb.desarrollo.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.desarrollo.daleb/", name = "operacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.desarrollo.daleb/", name = "operacionResponse")
