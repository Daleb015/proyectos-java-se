	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this,"Mensaje de prueba","Advertencia",3 );
				...
				JOptionPane.showInputDialog(Lamina_Cuadros_Dialogos.this,"Coloca nombre","Introduccion datos",2);
				...
				JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this, "Seleccionaste el 3", "confirmación", 0);
				...
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Selecciona", "Ventana de opcion", 1, 1, new ImageIcon("bin/graficos/cursiva.png"), null, null);
